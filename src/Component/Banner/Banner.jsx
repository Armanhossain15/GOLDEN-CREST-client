    ...
    return (
        <div className="carousel w-full ">
            <div id="slide1" className="carousel-item relative w-full ">
                <div className="hero min-h-[520px]" style={{ backgroundImage: 'url(https://i.ibb.co/Jnf6NtJ/swimming-pool-beach-luxury-hotel-outdoor-pools-spa-amara-dolce-vita-luxury-hotel-resort-tekirova-kem.jpg)' }}>
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-2xl">
                            ...
                            <button className="px-8 rounded-none btn border-2 border-[#34402d] text-white bg-transparent ">Get Started</button>
                        </div>
                    </div>
                </div>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                <div className="hero min-h-[480px]" style={{ backgroundImage: 'url(https://i.ibb.co/2jP1KY3/3d-rendering-beautiful-comtemporary-luxury-bedroom-suite-hotel-with-tv-1.jpg)' }}>
                    <div className="hero-overlay bg-black bg-opacity-80"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-2xl">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                <div className="hero min-h-[480px]" style={{ backgroundImage: 'url(https://i.ibb.co/TWw24RQ/3d-rendering-beautiful-luxury-bedroom-suite-hotel-with-tv.jpg)' }}>
                    <div className="hero-overlay bg-black bg-opacity-80"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-2xl">
